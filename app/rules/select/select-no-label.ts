...
export const selectNoLabel: Rule = {
  ...
  help: "Add a `<label>` associated to the select via `for`/`id`, wrap the select in a `<label>`, or set `aria-label` for cases where a visible label genuinely cannot be shown.",
