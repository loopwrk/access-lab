...
export const selectOptionsEmpty: Rule = {
  ...
  help: "Populate the select with at least one meaningful option. If the options are loaded asynchronously, render a `<option disabled>Loading…</option>` placeholder until the real data arrives.",
