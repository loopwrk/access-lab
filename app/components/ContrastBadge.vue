...
const verdictMeta = computed(() => ({
  AAA: { label: t("contrast.verdictAAA"), color: "success" as const, icon: "i-lucide-check-circle-2" },
  AA: { label: t("contrast.verdictAA"), color: "success" as const, icon: "i-lucide-check" },
  AALarge: { label: t("contrast.verdictAALarge"), color: "warning" as const, icon: "i-lucide-alert-triangle" },
  Fail: { label: t("contrast.verdictFail"), color: "error" as const, icon: "i-lucide-x-circle" },
}[props.verdict]));
