...
<template>
  <div class="inline-flex items-stretch">
    ...
    <span
      class="self-stretch w-px bg-(--border)"
      aria-hidden="true"
    />
    <div class="flex items-center gap-2 px-3 py-1.5">
      <span
        v-if="isSingleVariant"
        class="font-mono text-(length:--al-font-size-body) text-(--text-secondary)"
      >
        ...
        <template #content>
          <div class="max-h-[calc(100vh-8rem)] overflow-y-auto bg-(--surface)">
            ...
            >
              ...
              <div class="py-2">
                <div
                  v-for="variant in section.items"
                  :key="variant.key"
                ...
                >
                  ...
                  >
                    <span class="flex items-center gap-2 flex-wrap">
                      ...
                      <UBadge
                        v-if="variant.status === 'recommended'"
                        color="success"
                        variant="soft"
                        size="md"
                    ...
                    <span
                      ...
                      class="text-(length:--al-font-size-body) text-(--text-secondary)"
                    >
                      {{ maybeTranslate(variant.description) }}
                    </span>

                    <UBadge
                      v-if="variant.statusNote && visualFor(variant.status)"
                  ...
                  <div
                    v-if="variant.seeAlsoTopicId"
                    class="px-4 pb-3 -mt-1"
                  >
                    <a
                      :href="`#topic-${variant.seeAlsoTopicId}`"
