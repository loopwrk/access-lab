...
export const placeholderDefinitions: Record<
  Exclude<
    ComponentId,
    "buttons-action-triggers" | "buttons-form-buttons" | "buttons-toggle-buttons" | "buttons-switches" | "buttons-disclosure-triggers" | "buttons-menu-triggers" | "input" | "checkbox" | "radio" | "select"
  >,
  ComponentDefinition
> = {
